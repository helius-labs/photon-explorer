...
export const mintExtensionsSchema = z.object({
  ...
  default_account_state: z.object({
    state: z.string(),
  }).optional(),
  confidential_transfer_account: z.object({
    approved: z.boolean(),
...
export const contentSchema = z.object({
  ...
  export const nonFungibleTokenSchema = fungibleTokenSchema.extend({
    // Extend with any additional properties specific to non-fungible tokens
  });
  ...
  export const apiResponseSchema = z.object({
    ...
    limit: z.number(),
    cursor: z.string(),
    items: z.array(z.union([fungibleTokenSchema, nonFungibleTokenSchema])),
  });
