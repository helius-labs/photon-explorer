          ...
          <div className="flex items-center w-3/4">
            ...
            <span className="flex items-center ml-2">
              <span className="flex font-bold">
                1,217
                <a
                  href="https://explorer.solana.com/address/85VBFQZC9TZkfaptBWjvUw7YbZjy52A6mjtPGjstQAmQ"
                  target="_blank"
                ...
                >
                  <img
                    src={token2ImageUri}
                    alt="Token"
                    className="h-6 w-6 ml-1 mr-2 rounded-md"
                  />
                </a>
              </span>
              ...
              <span className="flex font-bold ml-1">
                ...
                >
                  <img
                    src={tokenImageUri}
                    alt="Token"
                    className="h-6 w-6 ml-1 rounded-md"
                  />
                </a>
              </span>
            </span>
